...
public class FragmentFeedDialog extends DialogFragment implements DatePickerDialogListener
	...
	public static FragmentFeedDialog newInstance(int clicktype, String date, String time, String info) {
		FragmentFeedDialog frag = new FragmentFeedDialog();
